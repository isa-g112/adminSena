...
class Teacher extends Model
{
    ...
    protected $fillable = ['name', 'email', 'training_center_id', 'area_id'];
    ...
    'area.courses',
    'training_center.courses.aprentice',
    'area.courses.aprentice',
    'courses.aprentice.computer']; //las posibles Querys que se pueden realizar
    protected $allowFilter = ['name', 'email', 'training_center_id', 'area_id'];
    protected $allowSort = ['name', 'email', 'training_center_id', 'area_id'];
